...
export const action: ActionFunction = async ({ request }) => {
  ...
  try {
    ...
    const basketData = {
      ...
      time: timeValue ?? "",
      service_type: "Major Service and MOT", 
      price: 334.99, 
...
export default function MajorServiceandMOT() {
...
<div className="absolute top-5 right-5">
  ...
  <div className="mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto">
    <h1 className="text-3xl font-bold mb-4 text-center">Major Service and MOT</h1>

    <p>
      <span className="font-bold">From £334.99*</span>
    </p>
    <p>
