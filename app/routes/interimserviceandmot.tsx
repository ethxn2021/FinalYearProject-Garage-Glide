...
import { getMOTandInterimService} from "./data";




export const loader: LoaderFunction = async ({ request }) => {
  let data = await getMOTandInterimService();
  return { data };
};
...
export const action: ActionFunction = async ({ request }) => {
  ...
  try {
    ...
    const basketData = {
      ...
      time: timeValue ?? "",
      service_type: "Interim Service and MOT", 
      price: 234.99, 
...
export default function InterimServiceandMOT() {
...
<div className="absolute top-5 right-5">
  ...
  <div className="mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto">
    <h1 className="text-3xl font-bold mb-4 text-center">Interim Service and MOT</h1>

    <p>
      <span className="font-bold">From £234.99*</span>
    </p>
    <p>
