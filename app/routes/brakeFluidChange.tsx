...
import { getBrakeoil } from "./data";


export const loader: LoaderFunction = async ({ request }) => {
  let data = await getBrakeoil();
  return { data };
};
...
export default function BrakeFluidChange() {
...
<div className="absolute top-5 right-5">
  ...
  <div className="mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto">
    <h1 className="text-3xl font-bold mb-4 text-center">Brake Fluid Change</h1>
