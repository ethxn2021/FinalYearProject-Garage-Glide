...
import { addBasket, getServices } from "~/utils/db.server";
...
export const action: ActionFunction = async ({ request }) => {
  ...
  try {
    ...
    const basketData = {
      ...
      time: timeValue ?? "",
      service_type: "Advanced Diagnostic Check", 
      price: 49.99, 
...
export default function AdvancedDiagnosticCheck() {
...
<div className="absolute top-5 right-5">
  ...
  <div className="mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto">
    <h1 className="text-3xl font-bold mb-4 text-center">Advanced Diagnostic Check</h1>
