import { addBasket, updateGarageReply } from "~/utils/db.server";
    ...
    <><div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      <div className="absolute top-5 right-5">
        ...
        <div className="mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto">
          <h1 className="text-3xl font-bold mb-4 text-center">Interim Service</h1>

          <p>
            <span className="font-bold">From £149.99*</span>
          </p>
          <p>
            <span className="font-bold" style={{ color: "#3F72AF" }}>
              Book with an MOT and save £24.99
            </span>
          </p>
        ...
        <form className="mt-4" method="POST">
          <label htmlFor="registration" className="block mb-2 text-sm text-gray-700">
            ...
            <label htmlFor="selectedCentre" className="block mb-2 text-sm text-gray-700">
